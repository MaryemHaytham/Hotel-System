...
//   constructor(private _HelperService: HelperService, private _RoomsService: RoomsService, private dialog: MatDialog, private _ToastrService: ToastrService, private _Router: Router, private _ActivatedRoute: ActivatedRoute, private _FacilitiesService: FacilitiesService) {
